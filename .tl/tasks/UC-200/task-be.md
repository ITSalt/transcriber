---
id: UC-200-BE
title: Process transcription pipeline — backend
type: uc-be
uc: UC-200
...
# UC-200-BE — Process transcription pipeline (worker)

## User story

> As the SYSTEM, I dequeue a queued TranscriptionJob, run ASR + diarization on the recording, resolve speaker names, and persist a verbatim Transcript with status updates.
...
|--------|------|-------------|
| WORKER | `queue:transcriptionJob` | Process TranscriptionJob |
